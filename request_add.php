		...
		<div class="col-md-10 ">
			<form class="form-horizontal" method="post" id="request_add-form">
				<fieldset>
					...
					?>
					<div class="form-group">
  						<label class="col-md-4 control-label" for="from">* For</label>  
  						<div class="col-md-4">
        									...
        									try{
        									    ...
        									    while ($row = $sth->fetch(PDO::FETCH_OBJ)){
        									        if($row->idStaff == $_SESSION['user_info']['id']):
        									           echo "<option value='".$row->idStaff."' selected>".$row->fullname." *</option>";
        									        else:
					...
					<?php 
					   ...
					   echo "<input type='hidden' name='idStaff' value='".$_SESSION['user_info']['id']."'>";
					endif;
					?>
